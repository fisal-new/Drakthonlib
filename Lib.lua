--// DrakthonLib - Full Version with Responsive Design
local DrakthonLib = {}
...
function DrakthonLib.CreateLib(kavName, themeList, logoConfig)
    ...
    blurFrame.Size = UDim2.new(1, 8, 1, 11)
    ...
    AspectRatio.AspectRatio = 525/318
    
    local SizeConstraint = Instance.new("UISizeConstraint")
    SizeConstraint.Parent = Main
    SizeConstraint.MinSize = Vector2.new(450, 273)
    SizeConstraint.MaxSize = Vector2.new(900, 545)
    ...
    LogoFrame.Position = UDim2.new(0, 9, 0, 2)
    ...
    title.Position = UDim2.new(0, logoConfig.ImageId and 40 or 9, 0, 10)
    ...
    MainSide.Size = UDim2.new(0, 149, 1, -29)
    ...
    tabFrames.Size = UDim2.new(0, 135, 1, 0)
    ...
    pages.Size = UDim2.new(0, 360, 1, -68)
    ...
    function DrakthonLib:UpdateLogo(newLogoConfig)
        if newLogoConfig.ImageId then
            ...
            LogoFrame.Visible = false
            title.Position = UDim2.new(0, 9, 0, 10)
        end
    end
